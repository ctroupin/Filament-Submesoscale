...
datadir = "/home/ctroupin/data/SST/Global/monthly/2000/"


@testset "Date extraction" begin
    y, m = SST.get_year_month_file(joinpath(datadir, "TERRA_MODIS.20000201_20000229.L3m.MO.SST4.sst4.9km.nc"))
    @test y == 2000
    @test m == 2
end
...
@testset "SST reading" begin

    testfile = joinpath(datadir, "TERRA_MODIS.20000201_20000229.L3m.MO.SST4.sst4.9km.nc")
